...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        // Squared L2 distance between two SIFT descriptors (CV_32F, 128
        // cols) -- see ORBmatcher.cc's doc comment for why squared (not
        // sqrt'd) and why float (was int/Hamming for ORB's binary
        // descriptors).
